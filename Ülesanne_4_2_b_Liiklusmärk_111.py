...
#tahvel.create_polygon((zx, zy+391, zx+452, zy+391, zx+226, zy+0), overline="red", fill="white", width=20)
#tahvel.create_polygon((zx+58, zy+360, zx+394, zy+360, zx+226, zy+70), fill="white")
